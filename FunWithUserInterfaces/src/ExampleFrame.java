...
*/
/**
 * Illustrates how to create a simple user interface
 * with a button, text field, and label
 */
public class ExampleFrame extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == txtText) {
            JOptionPane.showMessageDialog(null,"You clicked enter in the text field.");
